...
class AdicionarOrcamentoTela extends StatefulWidget {
  ...
  AdicionarOrcamentoTela({this.cliente});
...
//Controllers
  ...
  TextEditingController _textObservacoes = new TextEditingController();
  ...
  Widget build(BuildContext context) {
    AlertDialog alert = AlertDialog(
      ...
      content: Text(
          "Se sair, você perderá todos os dados do orçamento. Deseja realmente sair?"),
      actions: [
        TextButton(
            onPressed: () {
              ...
              actions: <Widget>[
                GestureDetector(
                  ...
                  onTap: () async {
                    ...
                    await orcamentoController.incluirOrcamento(novoOrcamento);
                    produtos.clear();
                    Navigator.popAndPushNamed(context, '/inicial');
